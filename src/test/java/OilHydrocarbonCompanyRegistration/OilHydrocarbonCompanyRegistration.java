...
public class OilHydrocarbonCompanyRegistration {
    ...
    File file = new File("../resources/ExcelData/OilHydrocarbonCompanyRegistration.xlsx");
    ...
    public void launchBrowser() {
        ...
        driver.get("https://angularqa.gazt.gov.sa/angular/#/signup/others/oilHydrocarbon");
    ...
    public void negativeCompanyRegistration(Map<String, String> data) {
    ...
    public void positiveCompanyRegistration(Map<String, String> data) {
        SoftAssert softAssertion = new SoftAssert();
        // fill form
        organizationInformation.fillData(data);
        // click continue
    ...
    public void positiveCompleteInfo(Map<String, String> data) {
        completeInformation.fillData(data);
        SoftAssert softAssert = new SoftAssert();
//        if(completeInformation.verifyAttachmentIsUploaded()) {
//            softAssert.assertFalse(completeInformation.verifyDeleteAttachmentIsDisplayed(), "Verify attachment delete button is not displaying");
//        }
        completeInformation.clickContinueButton();
        try {
            Thread.sleep(1000);
        ...
        if(completeInformation.isAddBranchButtonVisible()){
