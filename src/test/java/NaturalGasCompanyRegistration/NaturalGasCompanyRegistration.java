...
public class NaturalGasCompanyRegistration {
    ...
    File file = new File("../resources/ExcelData/NaturalGasCompanyRegistration.xlsx");
    ...
    public void launchBrowser() {
        ...
        driver.get("https://angularqa.gazt.gov.sa/angular/#/signup/others/naturalGas");
    ...
    public void negativeCompleteInfo(Map<String, String> data) throws InterruptedException {
    ...
    public void positiveCompleteInfo(Map<String, String> data) throws InterruptedException {
        completeInformation = new CompleteInformation(driver);
        completeInformation.fillData(data);
        SoftAssert softAssert = new SoftAssert();
