...
public class Acknowledgement {
    ...
    //Locators
    private final By name=By.xpath("(//ancestor::mat-card//span)[2]");
    private final By applicationNumber=By.xpath("(//ancestor::mat-card//span)[4]");
    private final By date=By.xpath("(//ancestor::mat-card//span)[6]");
