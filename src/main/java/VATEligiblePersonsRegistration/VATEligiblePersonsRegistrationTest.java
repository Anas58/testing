...
public class VATEligiblePersonsRegistrationTest {
    ...
    File file = new File("/ExcelData/VATEligiblePersonsRegistration");
    ...
    @Test(enabled = false, dataProvider = "organization_information_labels", groups = {"regression"}, priority = 9)
    ...
    @Test(enabled = false, dataProvider = "OrganizationInformationPage_negative_scenario", groups = {"regression"}, priority =10 )
    ...
    @Test(enabled = false, priority = 11, groups = {"regression"})
    ...
    @Test(enabled = true, dataProvider = "OrganizationInformationPage_positive_scenario", groups = {"regression", "smoke"}, priority = 0)
    ...
    @Test(enabled = true, dataProvider = "VerificationCodePage_positive_scenario", groups = {"regression"}, priority = 1)
    ...
    @Test(enabled = true, dataProvider = "password_labels", groups = {"regression"}, priority = 7)
    ...
    @Test (enabled = true, dataProvider = "password_negative_scenario", priority = 8)
    ...
    @Test(enabled = false, dataProvider = "password_positive_scenario", priority = 7)
