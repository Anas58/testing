...
public class VerificationCode {
    ...
    private By completeInformationPage =By.xpath("//div[contains(text(),'Complete Information')]");
...
//     enter Verification Code
    ...
    // check The Next page
    public boolean checkCompleteInfoPageIsDisplayed() {
        return driver.findElement(completeInformationPage).isDisplayed();
    }
