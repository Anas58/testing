...
public class AddNewBranch {
    ...
    private final By validFromField = By.xpath("//input[@formcontrolname='validFrom']");
    ...
    private final By tmp = By.xpath("//form[@formgroupname='contactPersonDetails']//span[contains(@class,'mat-select-value-text')]");
