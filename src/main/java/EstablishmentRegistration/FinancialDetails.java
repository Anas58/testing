...
public class FinancialDetails {
    ...
    //Locators
    By accountMethod = By.xpath("//mat-select[@formcontrolname='accounting']");
    By capitalAmount = By.xpath("//input[@formcontrolname='capitalAmount']");
    By checkCalenderTypeHijri = By.xpath("//input[@formcontrolname='hijriSelected']/parent::label");
    //By calenderTypeGregorian=By.xpath("//div//label//input[@formcontrolname='gregorianSelected']");
    By checkCalenderTypeGregorian = By.xpath("//input[@formcontrolname='gregorianSelected']/parent::label");
    By calenderTypeGregorian = By.xpath("//input[@formcontrolname=\"gregorianSelected\"]/ancestor::*[@data-toggle='buttons']");
    By calenderTypeHijri = By.xpath("//input[@formcontrolname=\"hijriSelected\"]/ancestor::*[@data-toggle='buttons']");
    //By calenderTypeGregorian=By.id("gregc");
    By endOfFinancialMonth = By.xpath("//mat-select[@formcontrolname='endOfFinancialMonth']");
    By endOfFinancialDay = By.xpath("//mat-select[@formcontrolname='endOfFinancialDay']");
    By financialPeriodOptions = By.xpath("//mat-radio-group[@formcontrolname='financialPeriod']//input[@class='mat-radio-input cdk-visually-hidden']");
    By taxableDate = By.xpath("//input[@formcontrolname='taxableDate']");
    By continueButton = By.xpath("//button[@class='rounded btnCss save-btn mat-focus-indicator mat-button mat-button-base ng-star-inserted']");
    By businessCommencementDate = By.xpath("//input[@formcontrolname='commencementDate']");
    By errorMessage=By.tagName("mat-error");


    //Dropdown Option Locator
    By option = By.tagName("mat-option");
...
//      Selecting Financial Optional
        ...
        if (totalOptions >= 2) {
            if (data.get("financial_period_options") != null) {
                if (data.get("financial_period_options").equals("L")) {
                    String labelId = driver.findElements(financialPeriodOptions).get(1).getAttribute("id");
                    driver.findElement(By.xpath("//label[@for='" + labelId + "']")).click();
                } else {
                    String labelId = driver.findElements(financialPeriodOptions).get(0).getAttribute("id");
                    driver.findElement(By.xpath("//label[@for='" + labelId + "']")).click();
                }
            }
        } else if(data.get("financial_period_options") != null) {
            String labelId = driver.findElements(financialPeriodOptions).get(0).getAttribute("id");
            driver.findElement(By.xpath("//label[@for='" + labelId + "']")).click();
        }
    }
    ...
    public boolean checkFinancialPageIsDisplayed(){
        return driver.findElement(capitalAmount).isDisplayed();
    }
