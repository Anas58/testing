...
public class AddNewBranch {
    ...
    private final By closePopupMessageButton = By.xpath("//div[@id='brErrorMsgsModal']//button[contains (@class,'save-btn')]");
    ...
    private final By labels=By.xpath("//div[contains(@class ,'registerLabelCss')]");
    ...
    //Verify Branch name Label.
    public String verifyBranchLabel(){
       String branch_name;
        branch_name = driver.findElement(with(labels).above(branchNameField)).getText();
        return branch_name;
    }
    ...
    /*public void fillContactPerson(Map<String, String> data) {
        ...
        if (data.get("copyOfGeneralManagerID") != null) {
            ...
            driver.findElement(copyOfGeneralManagerIDAttachment).sendKeys(data.get("copyOfGeneralManagerID"));
    ...
    public void clickClosePopupMessage() {
        if(existsElement(closePopupMessageButton)){
            if(driver.findElement(closePopupMessageButton).isDisplayed()){
    ...
    public boolean isAddressPageClosed() {
        try {
            driver.findElement(districtField);
        } catch (NoSuchElementException e){
            return false;
        }
        return true;
    ...
    public boolean checkAddressPageIsDisplayed() {
        return driver.findElement(districtField).isDisplayed();
    }
