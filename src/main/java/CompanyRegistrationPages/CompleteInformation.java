...
public class CompleteInformation {
    ...
    private final By addNewShareholdersButton = By.xpath("//shareholders-details//button[@mat-button and @type='button']");
    ...
    public String getFieldsLabels(String key){
        WebElement element_label = switch(key){
            case "reporting_branch" -> driver.findElement(with(label).above(reportingBranch));
